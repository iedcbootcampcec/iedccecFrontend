...
export default function Announcement() {
  ...
  return (
      ...
      <div class="mt-7 flex flex-row flex-wrap w-full">
        ...
        <div>
          <div  class="bg-white w-[180px] h-[180px] mr-12 rounded-full border-solid border border-gray-300 ">
            <img class="rounded-full border-8 border-gray-200 shadow-xl" src={img4} alt=""/>
          </div>
           
            <div class="mt-4">
              <a
                href=""
                class="ml-7 font-bold "
                >Parvathy Madhu</a>
            </div>
          ...
          <div class="px-0 mb-3">
          <div class="bg-white w-[180px] h-[180px] mr-12 rounded-full border-solid border border-gray-300 ">
            <img class="rounded-full border-8 border-gray-200 shadow-xl" src={img5} alt=""/>
          </div>
            <div class="mt-4">
              <a
                href=""
                class="font-bold px-2 ml-1"
                >Archana Lejikumar</a
              >
            </div>
        ...
        <div>
          <div class="bg-white w-[180px] h-[180px] mr-12 rounded-full border-solid border border-gray-300 ">
            <img class="rounded-full border-8 border-gray-200 shadow-xl" src={img6} alt=""/>
          </div>
            <div class="mt-4">
              <a
                href=""
                class="font-bold px-2 ml-4"
                >Suji Marium Saji</a
              >
            </div>
          ...
          <div class="px-3 mb-3">
            <div class="bg-white w-[180px] h-[180px] mr-12 rounded-full border-solid border border-gray-300 ">
              <img class="rounded-full border-8 border-gray-200 shadow-xl" src={img7} alt=""/>
            </div>
              <div class="mt-4">
              <a
                href=""
                class="font-bold px-2 ml-3"
                >Durga Ajithkumar</a
              >
            </div>
    ...
    <div class="mt-7 ml-16 flex flex-row flex-wrap w-full">
      ...
      <div>
        <div class="bg-white w-[180px] h-[180px] mr-12 rounded-full border-solid border border-gray-300 ">
          <img class="rounded-full border-8 border-gray-200 shadow-xl" src={img8} alt=""/>
        </div>
         
          <div class="mt-4">
            <a
              href=""
              class="font-bold ml-11 "
              >Haripriya P</a
            >
          </div>
      ...
      <div class="px-3 mb-3">
        <div class="bg-white w-[180px] h-[180px] mr-12 rounded-full border-solid border border-gray-300 ">
          <img class="rounded-full border-8 border-gray-200 shadow-xl" src={img9} alt=""/>
        </div>
          <div class="mt-4">
            <a
              href=""
              class="font-bold px-2"
              >Breesa Eliswa Manoj</a
            >
          </div>
      ...
      <div>
        <div class="bg-white w-[180px] h-[180px] mr-12 rounded-full border-solid border border-gray-300 ">
          <img class="rounded-full border-8 border-gray-200 shadow-xl" src={img10} alt=""/>
        </div>
          <div class="mt-4">
            <a
              href=""
        ...
        <div class="px-3 mb-3">
          <div class="bg-white w-[180px] h-[180px] mr-12 rounded-full border-solid border border-gray-300 ">
            <img class="rounded-full border-8 border-gray-200 shadow-xl" src={img11} alt=""/>
          </div>
            <div class="mt-4">
            <a
              href=""
              class="font-bold px-2 ml-6"
              >Visal Krishnan</a
            >
          </div>
        ...
        <div>
          <div class="bg-white w-[180px] h-[180px] mr-12 rounded-full border-solid border border-gray-300 ">
            <img class="rounded-full border-8 border-gray-200 shadow-xl" src={img12} alt=""/>
          </div>
            <div class="mt-4">
              <a
                href=""
                class="font-bold px-2 ml-5"
                >Prajeeth Menon</a
              >
            </div>
